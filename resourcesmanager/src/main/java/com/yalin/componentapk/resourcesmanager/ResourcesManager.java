package com.yalin.componentapk.resourcesmanager;
...
import com.yalin.componentapk.resourcesmanager.utils.BrandUtil;
import com.yalin.componentapk.resourcesmanager.utils.ReflectUtil;
...
//                ReflectUtil.invoke(AssetManager.class, assetManager,
//                        "addAssetPath", context.getApplicationInfo().sourceDir);
//            } else {
//                assetManager = hostResources.getAssets();
//            }
//            ReflectUtil.invoke(AssetManager.class, assetManager, "addAssetPath", apkFile);
//            apkResources = createResourcesCompat(hostResources)
//                    .createCompatResources(context, hostResources, assetManager);
//            hookResources(context, apkResources);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//
